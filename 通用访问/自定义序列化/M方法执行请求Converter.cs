...
{
    public class M方法执行请求Converter : JsonConverter
    {
        //_方法.形参列表.Find(q => q.名称 == __名称).元数据.
        public override bool CanConvert(Type objectType)
        {
            return (objectType == typeof(M方法执行请求));
        }
