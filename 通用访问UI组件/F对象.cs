...
namespace 通用访问工具
{
    public partial class F对象 : UserControl
    {
        public M对象明细查询结果 对象明细 { get; set; }
        ...
        public void 更新角色(E角色 __角色)
        {
            ...
            else
            {
                ...
                对象明细.方法列表.ForEach(q =>
                {
                    ...
                    var __方法控件 = new F对象_方法(访问入口, 对象名称, q) {Dock = DockStyle.Fill};
                ...
                对象明细.事件列表.ForEach(q =>
                {
                    ...
                    var __事件控件 = new F对象_事件(访问入口, 对象名称, q) { Dock = DockStyle.Fill };
