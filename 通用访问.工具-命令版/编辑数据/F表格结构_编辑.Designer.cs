namespace 通用访问工具.编辑数据
{
    partial class F表格结构_编辑
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(F表格结构_编辑));
            ...
            this.out元数据 = new System.Windows.Forms.DataGridView();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.out元数据)).BeginInit();
            ...
            // 
            this.splitContainer1.Panel2.Controls.Add(this.out元数据);
            ...
            this.out值.Size = new System.Drawing.Size(776, 179);
            this.out值.TabIndex = 9;
            // 
            // out元数据
            // 
            this.out元数据.AllowUserToAddRows = false;
            this.out元数据.AllowUserToDeleteRows = false;
            this.out元数据.BorderStyle = System.Windows.Forms.BorderStyle.None;
            this.out元数据.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            this.out元数据.Columns.AddRange(new System.Windows.Forms.DataGridViewColumn[] {
            this.Column1,
            ...
            this.out元数据.Dock = System.Windows.Forms.DockStyle.Fill;
            this.out元数据.Location = new System.Drawing.Point(0, 0);
            this.out元数据.Name = "out元数据";
            this.out元数据.ReadOnly = true;
            this.out元数据.RowTemplate.Height = 23;
            this.out元数据.Size = new System.Drawing.Size(776, 123);
            this.out元数据.TabIndex = 8;
            // 
            // Column1
            // 
            ...
            this.out标题.Size = new System.Drawing.Size(68, 17);
            this.out标题.TabIndex = 4;
            this.out标题.Text = "表格结构值";
            // 
            // pictureBox1
            // 
            ...
            ((System.ComponentModel.ISupportInitialize)(this.out元数据)).EndInit();
        ...
        private System.Windows.Forms.DataGridView out元数据;
