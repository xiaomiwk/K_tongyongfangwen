...
namespace 通用访问.工具
{
    public partial class F主窗口 : FormK
    {
        ...
        void out设备列表_NodeMouseDoubleClick(object sender, TreeNodeMouseClickEventArgs e)
        {
            ...
            if (__设备.访问入口 == null)
            {
                __设备.控件 = new F命令列表(new IPEndPoint(__设备.IP, __设备.端口号), __设备.名称) { Dock = DockStyle.Fill };
                this.out命令明细容器.添加控件(__设备.控件);
